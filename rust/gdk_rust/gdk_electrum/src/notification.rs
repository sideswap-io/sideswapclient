...
impl Notification {
    ...
    pub fn new_sync_failed() -> Self {
        Notification {
            network: None,
            transaction: None,
            block: None,
            event: Kind::SyncFailed,
        }
    }

    pub fn new_sync_complete() -> Self {
        Notification {
            network: None,
            transaction: None,
            block: None,
            event: Kind::SyncComplete,
        }
    }
}
...
impl NativeNotif {
    ...
    pub fn sync_failed(&self) {
        self.notify(Notification::new_sync_failed());
    }

    pub fn sync_complete(&self) {
        self.notify(Notification::new_sync_complete());
    }

...
void main() {
  ...
  group('parse asset amount precision', () {
    test('precision: -1', () {
      expect(
        satoshiRepository.parseAssetAmount(amount: '0', precision: -1),
        equals(null),
      );
    });
    ...
    test('precision: 0', () {
      expect(
        satoshiRepository.parseAssetAmount(amount: '0', precision: 0),
        equals(0),
      );
    });
    ...
    test('precision: 8', () {
      expect(
        satoshiRepository.parseAssetAmount(amount: '0', precision: 8),
        equals(0),
      );
    });
    ...
    test('precision: 9', () {
      expect(
        satoshiRepository.parseAssetAmount(amount: '0', precision: 9),
        equals(null),
      );
    });
  });

  group('parse asset amount', () {

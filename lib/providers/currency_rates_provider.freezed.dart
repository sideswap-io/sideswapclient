...
/// Adds pattern-matching-related methods to [ConversionRate].
extension ConversionRatePatterns on ConversionRate {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _ConversionRate value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _ConversionRate() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _ConversionRate value)  $default,){
final _that = this;
switch (_that) {
case _ConversionRate():
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _ConversionRate value)?  $default,){
final _that = this;
switch (_that) {
case _ConversionRate() when $default != null:
return $default(_that);case _:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String name,  Decimal rate)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ConversionRate() when $default != null:
return $default(_that.name,_that.rate);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String name,  Decimal rate)  $default,) {final _that = this;
switch (_that) {
case _ConversionRate():
return $default(_that.name,_that.rate);}
}
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String name,  Decimal rate)?  $default,) {final _that = this;
switch (_that) {
case _ConversionRate() when $default != null:
return $default(_that.name,_that.rate);case _:
  return null;
...
/// Adds pattern-matching-related methods to [ConversionRates].
extension ConversionRatesPatterns on ConversionRates {
/// A variant of `map` that fallback to returning `orElse`.
///
/// It is equivalent to doing:
/// ```dart
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _UsdConversionRates value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _UsdConversionRates() when $default != null:
return $default(_that);case _:
  return orElse();
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _UsdConversionRates value)  $default,){
final _that = this;
switch (_that) {
case _UsdConversionRates():
return $default(_that);}
}
/// A variant of `map` that fallback to returning `null`.
///
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _UsdConversionRates value)?  $default,){
final _that = this;
switch (_that) {
case _UsdConversionRates() when $default != null:
return $default(_that);case _:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( List<ConversionRate> usdConversionRates)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _UsdConversionRates() when $default != null:
return $default(_that.usdConversionRates);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( List<ConversionRate> usdConversionRates)  $default,) {final _that = this;
switch (_that) {
case _UsdConversionRates():
return $default(_that.usdConversionRates);}
}
/// A variant of `when` that fallback to returning `null`
///
/// It is equivalent to doing:
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( List<ConversionRate> usdConversionRates)?  $default,) {final _that = this;
switch (_that) {
case _UsdConversionRates() when $default != null:
return $default(_that.usdConversionRates);case _:
  return null;

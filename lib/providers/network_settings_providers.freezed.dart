...
/// Adds pattern-matching-related methods to [NetworkSettingsModel].
extension NetworkSettingsModelPatterns on NetworkSettingsModel {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>({TResult Function( NetworkSettingsModelEmpty value)?  empty,TResult Function( NetworkSettingsModelApply value)?  apply,required TResult orElse(),}){
final _that = this;
switch (_that) {
case NetworkSettingsModelEmpty() when empty != null:
return empty(_that);case NetworkSettingsModelApply() when apply != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>({required TResult Function( NetworkSettingsModelEmpty value)  empty,required TResult Function( NetworkSettingsModelApply value)  apply,}){
final _that = this;
switch (_that) {
case NetworkSettingsModelEmpty():
return empty(_that);case NetworkSettingsModelApply():
return apply(_that);}
}
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>({TResult? Function( NetworkSettingsModelEmpty value)?  empty,TResult? Function( NetworkSettingsModelApply value)?  apply,}){
final _that = this;
switch (_that) {
case NetworkSettingsModelEmpty() when empty != null:
return empty(_that);case NetworkSettingsModelApply() when apply != null:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function( SettingsNetworkType? settingsNetworkType,  int? env,  String? host,  int? port,  bool? useTls)?  empty,TResult Function( SettingsNetworkType? settingsNetworkType,  int? env,  String? host,  int? port,  bool? useTls)?  apply,required TResult orElse(),}) {final _that = this;
switch (_that) {
case NetworkSettingsModelEmpty() when empty != null:
return empty(_that.settingsNetworkType,_that.env,_that.host,_that.port,_that.useTls);case NetworkSettingsModelApply() when apply != null:
return apply(_that.settingsNetworkType,_that.env,_that.host,_that.port,_that.useTls);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function( SettingsNetworkType? settingsNetworkType,  int? env,  String? host,  int? port,  bool? useTls)  empty,required TResult Function( SettingsNetworkType? settingsNetworkType,  int? env,  String? host,  int? port,  bool? useTls)  apply,}) {final _that = this;
switch (_that) {
case NetworkSettingsModelEmpty():
return empty(_that.settingsNetworkType,_that.env,_that.host,_that.port,_that.useTls);case NetworkSettingsModelApply():
return apply(_that.settingsNetworkType,_that.env,_that.host,_that.port,_that.useTls);}
}
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function( SettingsNetworkType? settingsNetworkType,  int? env,  String? host,  int? port,  bool? useTls)?  empty,TResult? Function( SettingsNetworkType? settingsNetworkType,  int? env,  String? host,  int? port,  bool? useTls)?  apply,}) {final _that = this;
switch (_that) {
case NetworkSettingsModelEmpty() when empty != null:
return empty(_that.settingsNetworkType,_that.env,_that.host,_that.port,_that.useTls);case NetworkSettingsModelApply() when apply != null:
return apply(_that.settingsNetworkType,_that.env,_that.host,_that.port,_that.useTls);case _:

...
String _$inputsWalletTypeFlagNotifierHash() =>
    r'43e55a116ea60d1be7e66e1a82097f24dfc476f9';
...
final inputsWalletTypeFlagNotifierProvider = AutoDisposeNotifierProvider<
    InputsWalletTypeFlagNotifier, InputsWalletTypeFlag>.internal(
...
/// See also [InputsNotifier].
@ProviderFor(InputsNotifier)
final inputsNotifierProvider =
...
typedef _$InputsNotifier = AutoDisposeNotifier<List<InputsItem>>;
...
final selectedInputsNotifierProvider = AutoDisposeNotifierProvider<
    SelectedInputsNotifier, List<InputsTxItem>>.internal(

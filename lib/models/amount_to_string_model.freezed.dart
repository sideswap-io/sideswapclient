...
/// Adds pattern-matching-related methods to [AmountToStringParameters].
extension AmountToStringParametersPatterns on AmountToStringParameters {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _AmountToStringParameters value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _AmountToStringParameters() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _AmountToStringParameters value)  $default,){
final _that = this;
switch (_that) {
case _AmountToStringParameters():
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _AmountToStringParameters value)?  $default,){
final _that = this;
switch (_that) {
case _AmountToStringParameters() when $default != null:
return $default(_that);case _:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int amount,  bool forceSign,  int precision,  bool trailingZeroes,  bool useNumberFormatter)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _AmountToStringParameters() when $default != null:
return $default(_that.amount,_that.forceSign,_that.precision,_that.trailingZeroes,_that.useNumberFormatter);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int amount,  bool forceSign,  int precision,  bool trailingZeroes,  bool useNumberFormatter)  $default,) {final _that = this;
switch (_that) {
case _AmountToStringParameters():
return $default(_that.amount,_that.forceSign,_that.precision,_that.trailingZeroes,_that.useNumberFormatter);}
}
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int amount,  bool forceSign,  int precision,  bool trailingZeroes,  bool useNumberFormatter)?  $default,) {final _that = this;
switch (_that) {
case _AmountToStringParameters() when $default != null:
return $default(_that.amount,_that.forceSign,_that.precision,_that.trailingZeroes,_that.useNumberFormatter);case _:
  return null;
...
/// Adds pattern-matching-related methods to [AmountToStringNamedParameters].
extension AmountToStringNamedParametersPatterns on AmountToStringNamedParameters {
/// A variant of `map` that fallback to returning `orElse`.
///
/// It is equivalent to doing:
/// ```dart
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _AmountToStringNamedParameters value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _AmountToStringNamedParameters() when $default != null:
return $default(_that);case _:
  return orElse();
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _AmountToStringNamedParameters value)  $default,){
final _that = this;
switch (_that) {
case _AmountToStringNamedParameters():
return $default(_that);}
}
/// A variant of `map` that fallback to returning `null`.
///
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _AmountToStringNamedParameters value)?  $default,){
final _that = this;
switch (_that) {
case _AmountToStringNamedParameters() when $default != null:
return $default(_that);case _:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int amount,  String ticker,  bool forceSign,  int precision,  bool trailingZeroes,  bool useNumberFormatter)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _AmountToStringNamedParameters() when $default != null:
return $default(_that.amount,_that.ticker,_that.forceSign,_that.precision,_that.trailingZeroes,_that.useNumberFormatter);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int amount,  String ticker,  bool forceSign,  int precision,  bool trailingZeroes,  bool useNumberFormatter)  $default,) {final _that = this;
switch (_that) {
case _AmountToStringNamedParameters():
return $default(_that.amount,_that.ticker,_that.forceSign,_that.precision,_that.trailingZeroes,_that.useNumberFormatter);}
}
/// A variant of `when` that fallback to returning `null`
///
/// It is equivalent to doing:
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int amount,  String ticker,  bool forceSign,  int precision,  bool trailingZeroes,  bool useNumberFormatter)?  $default,) {final _that = this;
switch (_that) {
case _AmountToStringNamedParameters() when $default != null:
return $default(_that.amount,_that.ticker,_that.forceSign,_that.precision,_that.trailingZeroes,_that.useNumberFormatter);case _:
  return null;

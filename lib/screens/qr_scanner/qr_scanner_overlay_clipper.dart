...
class QrScannerOverlayClipper extends CustomClipper<Path> {
  ...
  Path getClip(Size size) {
    final innerLeftTop1 = Offset(size.width / 2 - innerWidth / 2,
        size.height / 2 - innerHeight / 2 + radius);
    final innerLeftTop2 = Offset(size.width / 2 - innerWidth / 2 + radius,
        size.height / 2 - innerHeight / 2);
    final innerRightTop1 = Offset(size.width / 2 + innerWidth / 2 - radius,
        size.height / 2 - innerHeight / 2);
    final innerRightTop2 = Offset(size.width / 2 + innerWidth / 2,
        size.height / 2 - innerHeight / 2 + radius);
    final innerRightBottom1 = Offset(size.width / 2 + innerWidth / 2,
        size.height / 2 + innerHeight / 2 - radius);
    final innerRightBottom2 = Offset(size.width / 2 + innerWidth / 2 - radius,
        size.height / 2 + innerHeight / 2);
    final innerLeftBottom1 = Offset(size.width / 2 - innerWidth / 2 + radius,
        size.height / 2 + innerHeight / 2);
    final innerLeftBottom2 = Offset(size.width / 2 - innerWidth / 2,
        size.height / 2 + innerHeight / 2 - radius);
